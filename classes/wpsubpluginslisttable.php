...
class WP_Subplugins_List_Table extends WP_List_Table {
    ...
    function __construct($redirectPage) {
      ...
      /* Fix 20130605: incorrect global assign. Found by Anton Oliinyk working on Empire Builder plugin (George Katsoudas)
       global $current_screen;
      Fix 20130706: for some reason this refix wasn't applied. Subversion problem???
    ...
    /**
     * 1.7.60 deleted unused variable causing warning errors.
     */
    ...
    function display_rows() {
        ...
        foreach ( $this->items as $plugin_file => $plugin_data )
            $this->single_row_old( $plugin_file, $plugin_data );
    }
     ...
     * 20130917: to avoid further incompatibilites, single_row is changed to single_row_old
     * Watch out however, WP has changed single_row functionality.
     * @param $plugin_file
     * @param $plugin_data
     */
    function single_row_old( $plugin_file, $plugin_data ) {
